            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e9abaac8-a0b1-4b69-80b1-aa85cc7e4e11"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("5fd63170-4e0a-47cd-8036-56253655ecac"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("bac8cbd3-8433-4f6e-b14e-fab314e5ea65"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("46d6baac-cac5-441a-b010-531343ed1ebd"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$gqtmW24srBZEFPhiRIa9Q.2LuiaS2Z3SxXF2Ux4tbll.gWdsycQfi",
                            RoleId = new Guid("e9abaac8-a0b1-4b69-80b1-aa85cc7e4e11"),
                            Salt = "$2a$10$gqtmW24srBZEFPhiRIa9Q.",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4ba44053-fb79-4aeb-9c81-ea9ca54c3b7b"),
                            Balance = 0m,
                            UserId = new Guid("46d6baac-cac5-441a-b010-531343ed1ebd")
                        });
                });
