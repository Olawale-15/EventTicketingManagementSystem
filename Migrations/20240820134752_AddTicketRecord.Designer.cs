...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240820134752_AddTicketRecord")]
    partial class AddTicketRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d9220e84-22cd-4276-a294-3598e024d6a7"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("d2a5d0e2-86e8-4889-860f-d54b719c647e"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("df3f6744-8df7-420e-a19e-5bb10bf0e814"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6d4bd819-e9d0-4a79-b58c-d51e139217d2"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$0i9jZ689ged2VuBRhuSTquvWR2oyJpNryREHVLxt2ocERkp8YqSa.",
                            RoleId = new Guid("d9220e84-22cd-4276-a294-3598e024d6a7"),
                            Salt = "$2a$10$0i9jZ689ged2VuBRhuSTqu",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6cde22c5-5856-459c-863c-56551f39bf1b"),
                            Balance = 0m,
                            UserId = new Guid("6d4bd819-e9d0-4a79-b58c-d51e139217d2")
                        });
                });
