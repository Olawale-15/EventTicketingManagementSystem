...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240801160553_InitialSeedData")]
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ba117bdc-a7d6-4af4-bb6c-14c26da89923"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("50a03c94-8294-477b-8323-d580e3318b09"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("1326682e-8e3d-4a53-bdb1-955d41a067a8"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f05c6d7e-e545-4b05-9c0b-6fe8ed098773"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$/KzraG4Pr3PnaFb.d/07ye8n3WRtYXA.Lqih33wG1I9L6yiJB.GrK",
                            RoleId = new Guid("ba117bdc-a7d6-4af4-bb6c-14c26da89923"),
                            Salt = "$2a$10$/KzraG4Pr3PnaFb.d/07ye",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("626286b9-60a5-426f-8aa8-2bfe16391bbb"),
                            Balance = 0m,
                            UserId = new Guid("f05c6d7e-e545-4b05-9c0b-6fe8ed098773")
                        });
                });
