...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240826092551_Restart")]
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("479691df-0a60-47cb-bcae-5d0704f8beef"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("a9642cfe-4bb5-4bd0-a501-02576459a822"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("720cc931-2768-4417-a9bf-badacb8497ab"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9970ed8c-d851-4173-900e-84a0b4caa837"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$yNXRInrrAPs/Q5CXEXwkjOxJxeWfbUL4K3Yw6uBYE/muAPXs.Heh.",
                            RoleId = new Guid("479691df-0a60-47cb-bcae-5d0704f8beef"),
                            Salt = "$2a$10$yNXRInrrAPs/Q5CXEXwkjO",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("904d335b-4e92-4265-9bf7-4d1707c4b253"),
                            Balance = 0m,
                            UserId = new Guid("9970ed8c-d851-4173-900e-84a0b4caa837")
                        });
                });
