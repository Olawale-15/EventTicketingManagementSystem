...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240820174043_AddTicketRecor")]
    partial class AddTicketRecor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2fb8201d-ad75-4e66-879b-2ec087aa6613"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("0069f13b-e0e6-4c22-9af3-d4007c324273"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("a77ecb0a-d9f8-4a07-8b76-b89e20bf39af"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a99aee69-89ea-4930-9f51-feaec725b69a"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$tgpQCciTFsKH0eKA1g/uhufRg33Wylen9Vuqh7zf7vIq.AjvLYRSG",
                            RoleId = new Guid("2fb8201d-ad75-4e66-879b-2ec087aa6613"),
                            Salt = "$2a$10$tgpQCciTFsKH0eKA1g/uhu",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a3150180-55b6-4ee7-9014-69ea0713e475"),
                            Balance = 0m,
                            UserId = new Guid("a99aee69-89ea-4930-9f51-feaec725b69a")
                        });
                });
