...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240815172019_Modified")]
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3e1c5c73-6520-4e8d-a11e-49a607a30017"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("d1f2c904-735a-4d7b-a8c6-56e972b86c21"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("f422457d-b47d-4198-bc63-62f474492a99"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("32996ecd-dc79-46d1-a5e0-b1f78fdc3c8a"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$.K7wMAh4OmbQt7hG1LMhE.PySKoHGWass1i.D7VMg898H1YY.IrOy",
                            RoleId = new Guid("3e1c5c73-6520-4e8d-a11e-49a607a30017"),
                            Salt = "$2a$10$.K7wMAh4OmbQt7hG1LMhE.",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6e3123f3-cb17-4f71-956d-e280692e5cce"),
                            Balance = 0m,
                            UserId = new Guid("32996ecd-dc79-46d1-a5e0-b1f78fdc3c8a")
                        });
                });
