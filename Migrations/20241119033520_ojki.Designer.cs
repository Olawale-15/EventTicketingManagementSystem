            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ee6c83ba-120d-4224-be42-ddd5dd0299bf"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("5dfe5fa5-e63a-42c4-bf99-5f00f5597ffa"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("74847557-4129-4ea8-8b89-de8d33cb0ff4"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f10118a2-61b6-480a-8636-0a41400b7b2b"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$7bH23x8uOUQbbg1wY0Q8BOZZjE8SimY.kMJYHbMKLMz9Kn88x5iHi",
                            RoleId = new Guid("ee6c83ba-120d-4224-be42-ddd5dd0299bf"),
                            Salt = "$2a$10$7bH23x8uOUQbbg1wY0Q8BO",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3253479c-8e08-403a-84cc-ea4ac4459e4e"),
                            Balance = 0m,
                            UserId = new Guid("f10118a2-61b6-480a-8636-0a41400b7b2b")
                        });
                });
