...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240812154204_UpdateWalletTransactionsProp")]
    partial class UpdateWalletTransactionsProp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("900741d5-aa63-4f3e-9129-ceb1ef51d03c"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("2b916610-815d-4684-9121-31bf6c55de84"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("38434b04-4527-4b0e-9e31-cc5306ad8314"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6582a08a-a94f-4f2f-b41b-2ccb0cff30f1"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$WN4WUtK1n2xYUj6n5pgW.OIWLsd0dpy92Ct4Ux68CI7gYUy20EH22",
                            RoleId = new Guid("900741d5-aa63-4f3e-9129-ceb1ef51d03c"),
                            Salt = "$2a$10$WN4WUtK1n2xYUj6n5pgW.O",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b13720c8-431d-4077-af6b-f1bb2a9ed378"),
                            Balance = 0m,
                            UserId = new Guid("6582a08a-a94f-4f2f-b41b-2ccb0cff30f1")
                        });
                });
