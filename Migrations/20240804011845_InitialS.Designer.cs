...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240804011845_InitialS")]
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e372d93e-16b6-430c-80cd-8d0b772d6753"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("591743c6-53f3-43df-85be-cee239001d45"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("6035035c-81e2-4367-beaa-61ac8979015b"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cbf1ac46-724e-45d4-ace8-55c0e42d4c38"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$k7NDCRNIZTWgDs8/PNux3OzbYKm0TywSMAGkazDQtU1ONA.lHgdx2",
                            RoleId = new Guid("e372d93e-16b6-430c-80cd-8d0b772d6753"),
                            Salt = "$2a$10$k7NDCRNIZTWgDs8/PNux3O",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7127b573-2375-4eda-a82c-a05ef707431a"),
                            Balance = 0m,
                            UserId = new Guid("cbf1ac46-724e-45d4-ace8-55c0e42d4c38")
                        });
                });
