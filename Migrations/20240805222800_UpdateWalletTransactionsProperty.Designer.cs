...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240805222800_UpdateWalletTransactionsProperty")]
    partial class UpdateWalletTransactionsProperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("72c9f0a4-6e68-4092-bc43-d00ac07ee105"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("9366f04c-5621-4da2-99f3-7e7f1a908c45"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("516f2f1e-e619-4c2d-905d-82f844bf0d87"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f78a7f38-eb77-4b51-a593-8fc01e3fbfbb"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$nJYrsvnjWm81DMjKTEXgguB7O6TaLsx8OI5wsd7b3xq5tWvyXJTja",
                            RoleId = new Guid("72c9f0a4-6e68-4092-bc43-d00ac07ee105"),
                            Salt = "$2a$10$nJYrsvnjWm81DMjKTEXggu",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3937e421-d609-4feb-9bf8-90b281031d85"),
                            Balance = 0m,
                            UserId = new Guid("f78a7f38-eb77-4b51-a593-8fc01e3fbfbb")
                        });
                });
