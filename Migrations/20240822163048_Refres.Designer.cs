...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240822163048_Refres")]
    partial class Refres
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1dacf4bd-8b66-4932-a33d-f33b1775d44e"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("ac1d148f-ecc4-4db3-8710-e8d414003687"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("f842d80e-e59c-487b-ae9b-f22ad80760d2"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e2273ad7-b0d6-4cbc-8ff3-d709c0d7daa6"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$W8LtePPd44sSAb/Z0SwFru3fxE/bHF0is2kAsksbQ0roVDP1RqG2a",
                            RoleId = new Guid("1dacf4bd-8b66-4932-a33d-f33b1775d44e"),
                            Salt = "$2a$10$W8LtePPd44sSAb/Z0SwFru",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b0cfda33-36f8-467e-8cdd-0b27fc1c051b"),
                            Balance = 0m,
                            UserId = new Guid("e2273ad7-b0d6-4cbc-8ff3-d709c0d7daa6")
                        });
                });
