...
namespace EventTicketingApp.Migrations
{
    ...
    [Migration("20240821074920_Refresh")]
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("044d3ff7-6a83-4a3e-a8f3-c2d6a91be959"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("ce1123e6-ced7-4d13-9010-6b45d120c24a"),
                            Name = "EventOrganizer"
                        },
                        new
                        {
                            Id = new Guid("896115d5-0475-494b-b3bc-88797d7099e9"),
                            Name = "Attendee"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7dc46ef2-6ce5-4837-9c7e-c3ac1d022e9d"),
                            Email = "admin@gmail.com",
                            PasswordHash = "$2a$10$5X56fD89QzZRUqjPPLi6cekQL8Z03TSIIjn89si2v2GbdDKDfKjyu",
                            RoleId = new Guid("044d3ff7-6a83-4a3e-a8f3-c2d6a91be959"),
                            Salt = "$2a$10$5X56fD89QzZRUqjPPLi6ce",
                            UserName = "CEO"
                        });
                });
            ...
            modelBuilder.Entity("EventTicketingApp.Core.Domain.Entities.Wallet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d7d5c479-a466-408d-8f17-8da07c94f53c"),
                            Balance = 0m,
                            UserId = new Guid("7dc46ef2-6ce5-4837-9c7e-c3ac1d022e9d")
                        });
                });
